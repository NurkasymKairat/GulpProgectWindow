...
/* harmony import */ var _modules_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/time */ "./src/js/modules/time.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_time__WEBPACK_IMPORTED_MODULE_3__["default"])('#days', '#hours', '#minutes', '#seconds', '2023-01-01');
...
var modal = function modal() {
  var btnTrigger = document.querySelector('.header_btn'),
      modal = document.querySelector('.popup_engineer'),
      btnClose = document.querySelector('.btn_1');

  function openModal(selector) {
    var selectModal = document.querySelector(selector);
    selectModal.classList.remove('hide');
    selectModal.classList.add('show'); // document.body.style.overflow = 'hidden';

    document.body.classList.add('modal-open');
  }

  function closeModal(selector) {
    var closeSelect = document.querySelector(selector);
    closeSelect.classList.add('hide');
    closeSelect.classList.remove('show'); // document.body.style.overflow = '';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var times = function times(days, hours, minutes, seconds, line) {
  ...
  function timeLIne() {
    ...
    day.innerHTML = "".concat(getZero(d));
    hour.innerHTML = "".concat(getZero(h));
    minute.innerHTML = "".concat(getZero(m));
    second.innerHTML = "".concat(getZero(s));
